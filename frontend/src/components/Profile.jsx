...
const Profile = () => {
  ...
  return (
    <div>
      ...
      <motion.div initial={{ opacity: 0, x: 100 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -100 }} transition={{ duration: 0.3 }} className="max-w-4xl mx-auto bg-white border border-gray-200 rounded-lg sm:rounded-2xl my-3 sm:my-5 p-4 sm:p-6 md:p-8 sm:mx-auto">
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-8 md:gap-12">
          ...
          <Button onClick={() => setOpen(true)} className="text-right self-end sm:self-auto cursor-pointer" variant="outline" size="sm">
            <Pen size={16} />
          </Button>
        </div>
